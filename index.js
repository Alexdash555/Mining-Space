...
bot.setWebHook(`https://miningspace.s3.eu-west-3.amazonaws.com/bot${TOKEN}`); // Update to your S3 bucket URL
...
bot.on("callback_query", (query) => {
    if (query && query.game_short_name === "Miningspace") {
        // Direct link to the game hosted on S3
        let gameurl = "https://miningspace.s3.eu-west-3.amazonaws.com/index.html"; // Replace with your S3 index.html URL
